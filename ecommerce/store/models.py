...
class Item(models.Model):
	...
	image1 =  models.ImageField(upload_to='media/img')
	image2 =  models.ImageField(upload_to='media/img', blank=True)
	image3 =  models.ImageField(upload_to='media/img', blank=True)
